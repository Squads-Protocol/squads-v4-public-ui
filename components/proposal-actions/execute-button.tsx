  ...
  return (
    <Dialog>
      <DialogTrigger
        ...
        className="h-10 px-4 py-2 rounded-md font-neue text-white dark:bg-white dark:text-stone-700 disabled:text-stone-500 dark:disabled:bg-stone-500 dark:disabled:text-stone-700/50 dark:hover:bg-stone-100 transition duration-200"
      >
